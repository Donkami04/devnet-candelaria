...
import { getDataClientsOjos } from "../../../utils/Api-candelaria/api";
import { PRTG_URL, CISCO_URL } from "../../../utils/Api-candelaria/api";
import "./TableClientsOjos.css";

export function TableClientsOjos() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const clientsList = await getDataClientsOjos();
