  ...
  return (
    <div className="main-dashboard-container">
      ...
      {indicators && (
          <SectionDash>
            <h2>
              Overall: <span className={overallIndicator < 99.95 ? 'kpi-red' : 'kpi-green'}>{overallIndicator}%</span>
            </h2>
        ...
        <SectionDash>
          <h2>
            Disponibilidad: <span className={disponibilidadIndicator < 99.95 ? 'kpi-red' : 'kpi-green'}>{disponibilidadIndicator && disponibilidadIndicator}%</span>
          </h2>
          <table className="kpi-table">
            <tbody>
              <tr>
                <td>CSP UP</td>
                <td className={clients && clients.csp_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.csp_up}</td>
                <td>CSP DOWN</td>
                <td className={clients && clients.csp_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.csp_down}</td>
                <td>CSP PAUSED</td>
                <td className={clients && clients.csp_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.csp_paused}</td>
              </tr>
              <tr>
                <td>CSS UP</td>
                <td className={clients && clients.css_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.css_up}</td>
                <td>CSS DOWN</td>
                <td className={clients && clients.css_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.css_down}</td>
                <td>CSS PAUSED</td>
                <td className={clients && clients.css_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.css_paused}</td>
              </tr>
              <tr>
                <td>CNP UP</td>
                <td className={clients && clients.cnp_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.cnp_up}</td>
                <td>CNP DOWN</td>
                <td className={clients && clients.cnp_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnp_down}</td>
                <td>CNP PAUSED</td>
                <td className={clients && clients.cnp_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnp_paused}</td>
              </tr>
              <tr>
                <td>CNS UP</td>
                <td className={clients && clients.cns_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.cns_up}</td>
                <td>CNS DOWN</td>
                <td className={clients && clients.cns_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cns_down}</td>
                <td>CNS PAUSED</td>
                <td className={clients && clients.cns_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cns_paused}</td>
              </tr>
              <tr>
                <td>HSE UP</td>
                <td className={clients && clients.hse_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.hse_up}</td>
                <td>HSE DOWN</td>
                <td className={clients && clients.hse_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.hse_down}</td>
                <td>HSE PAUSED</td>
                <td className={clients && clients.hse_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.hse_paused}</td>
              </tr>
              <tr>
                <td>CNPB UP</td>
                <td className={clients && clients.cnpb_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.cnpb_up}</td>
                <td>CNPB DOWN</td>
                <td className={clients && clients.cnpb_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnpb_down}</td>
                <td>CNPB PAUSED</td>
                <td className={clients && clients.cnpb_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnpb_paused}</td>
              </tr>
              <tr>
                <td>CNSB UP</td>
                <td className={clients && clients.cnsb_up === 0 ? 'kpi-red' : 'kpi-green'}>{clients && clients.cnsb_up}</td>
                <td>CNSB DOWN</td>
                <td className={clients && clients.cnsb_down === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnsb_down}</td>
                <td>CNSB PAUSED</td>
                <td className={clients && clients.cnsb_paused === 0 ? 'kpi-green' : 'kpi-red'}>{clients && clients.cnsb_paused}</td>
              </tr>
